    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <Select value={String(tempSettings.concurrentDownloads || 1)} onValueChange={(value) => {
            const numValue = parseInt(value) as 1 | 2 | 3 | 4 | 5;
            setTempSettings(prev => ({ ...prev, concurrentDownloads: numValue }));
          }}>
            <SelectTrigger className="h-9 w-fit">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              ...
              <SelectItem value="3">3 - Fast ⚠️</SelectItem>
              <SelectItem value="4">4 - Very Fast ⚠️⚠️</SelectItem>
              <SelectItem value="5">5 - Maximum ⚠️⚠️⚠️</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Select value={tempSettings.outputFormat || "flac"} onValueChange={(value: "flac" | "mp3" | "aac") => setTempSettings((prev) => ({ ...prev, outputFormat: value }))}>
              <SelectTrigger className="h-9 w-fit">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                ...
                <SelectItem value="aac">AAC/M4A (Lossy)</SelectItem>
              </SelectContent>
            </Select>

            {tempSettings.outputFormat === "mp3" && (
              <Select value={tempSettings.mp3Bitrate || "320k"} onValueChange={(value: "128k" | "192k" | "256k" | "320k") => setTempSettings((prev) => ({ ...prev, mp3Bitrate: value }))}>
                <SelectTrigger className="h-9 w-fit">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            {tempSettings.outputFormat === "aac" && (
              <Select value={tempSettings.aacBitrate || "256k"} onValueChange={(value: "128k" | "192k" | "256k" | "320k") => setTempSettings((prev) => ({ ...prev, aacBitrate: value }))}>
                <SelectTrigger className="h-9 w-fit">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="320k">320 kbps</SelectItem>
                  <SelectItem value="256k">256 kbps (Recommended)</SelectItem>
                  <SelectItem value="192k">192 kbps</SelectItem>
                  <SelectItem value="128k">128 kbps</SelectItem>
                </SelectContent>
              </Select>
